...
-- -----------------------------------------------------
-- Table `value`.`2019q1_nums`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`2019q1_nums` ;

CREATE TABLE IF NOT EXISTS `value`.`2019q1_nums` (
...
-- -----------------------------------------------------
-- Table `value`.`2019q1_subs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`2019q1_subs` ;

CREATE TABLE IF NOT EXISTS `value`.`2019q1_subs` (
  `adsh` VARCHAR(20) NOT NULL,
  `cik` INT(10) NULL,
...
-- -----------------------------------------------------
-- Table `value`.`2019q1_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`2019q1_tags` ;

CREATE TABLE IF NOT EXISTS `value`.`2019q1_tags` (
  `tag` VARCHAR(256) NOT NULL,
...
-- -----------------------------------------------------
-- Table `value`.`2019q1_pres`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`2019q1_pres` ;

CREATE TABLE IF NOT EXISTS `value`.`2019q1_pres` (
  `adsh` VARCHAR(20) NOT NULL,
  `report` INT(6) NULL,
  `line` INT(6) NULL,
  `stmt` VARCHAR(2) NULL,
