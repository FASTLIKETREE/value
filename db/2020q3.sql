...
-- -----------------------------------------------------
-- Table `value`.`2020q3_nums`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`2020q3_nums` ;

CREATE TABLE IF NOT EXISTS `value`.`2020q3_nums` (
...
-- -----------------------------------------------------
-- Table `value`.`2020q3_subs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`2020q3_subs` ;

CREATE TABLE IF NOT EXISTS `value`.`2020q3_subs` (
  `adsh` VARCHAR(20) NOT NULL,
  `cik` INT(10) NULL,
...
-- -----------------------------------------------------
-- Table `value`.`2020q3_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`2020q3_tags` ;

CREATE TABLE IF NOT EXISTS `value`.`2020q3_tags` (
  `tag` VARCHAR(256) NOT NULL,
...
-- -----------------------------------------------------
-- Table `value`.`2020q3_pres`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`2020q3_pres` ;

CREATE TABLE IF NOT EXISTS `value`.`2020q3_pres` (
  `adsh` VARCHAR(20) NOT NULL,
  `report` INT(6) NULL,
  `line` INT(6) NULL,
  `stmt` VARCHAR(2) NULL,
