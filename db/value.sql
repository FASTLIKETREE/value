...
-- Table `value`.`nums`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`nums` ;

CREATE TABLE IF NOT EXISTS `value`.`nums` (
...
-- Table `value`.`subs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`subs` ;

CREATE TABLE IF NOT EXISTS `value`.`subs` (
  `adsh` VARCHAR(20) NOT NULL,
  `cik` INT(10) NULL,
...
-- Table `value`.`tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`tags` ;

CREATE TABLE IF NOT EXISTS `value`.`tags` (
  `tag` VARCHAR(256) NOT NULL,
...
-- Table `value`.`pres`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `value`.`pres` ;

CREATE TABLE IF NOT EXISTS `value`.`pres` (
  `adsh` VARCHAR(20) NOT NULL,
  `report` INT(6) NULL,
  `line` INT(6) NULL,
  `stmt` VARCHAR(2) NULL,
